...
//Usuario           // ME QUEDO POR AQUI (tengo que añadir lo de la clase cadena (mirar clase fecha tambien por si acaso))
...
//Funciones externas
void mostrar_carro(std::ostream& o,const Usuario& u) noexcept
{
    o << "Carrito de compra de "<< u.id() << " [Artículos: " << u.n_articulos() << "]" << std::endl;
    o << " Cant. Artículo" << std::endl;
    o << "=======================================================================" << std::endl;
    for(auto& i: u.compra())
    {
        o << i.second << "\t" << *i.first << std::endl;
    }
