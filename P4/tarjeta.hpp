...
inline const Fecha& Tarjeta::Caducada::cuando() const noexcept{return caducidad_;}      


    // Metodos inline clase de excepcion Num_duplicado
inline Tarjeta::Num_duplicado::Num_duplicado(const Numero& n): numero_{n}{}     
inline const Numero& Tarjeta::Num_duplicado::que() const noexcept{return numero_;}    
